...
<html lang="en">
    ...
    <body>
    <?php 
    public static prinFibunachi(int count){
        if(count < 0){
            int n2 =1;
            int n1 = 0;
            int n3 = n2 +n1;
    ...
    public function palindrom(char [] word){
        i1 = 0;
        i2 = word.length -1;
        while (12 > i1){
            if(word[i1] != word[i2]){
    ...
    public static F ( int number){
    int count = 10;
    echo "0". "1";
    prinFibunachi(count-2)
   }
    $a = array(1,2,3,4);
    $len = count($a);
    echo $len;
    ...
    public static double uniform (int li, int lo)
    var_dump($a);
    ?>
